        ...
        <div className="mt-16 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-4xl mx-auto">
            <blockquote className="text-xl md:text-2xl text-white italic leading-relaxed mb-4">
              "Ecotrax panels have revolutionized how we think about rural infrastructure. 
              The combination of sustainability, affordability, and durability makes this 
              a game-changer for remote communities."
            </blockquote>
            <cite className="text-bamboo-beige font-semibold">
              - Dr. Priya Sharma, Rural Development Institute
            </cite>
          </div>
        </div>
      </div>
